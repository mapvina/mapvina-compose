...
public class MapVinaMap(
  ...
  public external fun cameraForLatLngBounds(
    bounds: io.github.mapvina.kmp.native.util.LatLngBounds,
    padding: io.github.mapvina.kmp.native.util.EdgeInsets,
    bearing: Double? = null,
    pitch: Double? = null,
  ): CameraOptions
  ...
  ): io.github.mapvina.kmp.native.util.LatLngBounds
